...
def parse_fire_group_data(
    fg: dict, w: dict, w_d: Optional[dict], fire_groups_id_idx: Dict[int, dict],
) -> FireGroup:
            ...
            fire_mode: FireMode = FireMode(
                ...
                ammo=(
                    Ammo(
                        ...
                        clip_size=get(w_d, "clip_size", int) if w_d is not None else 0,
                ...
                recoil=Recoil(
                    ...
                    # Misc
                    first_shot_multiplier=get(fm, "recoil_first_shot_modifier", float),
...
def parse_attachment_fire_group_data(
    fg: dict, fire_groups_id_idx: Dict[int, dict],
) -> FireGroup:
        ...
        for _fg in sorted(
            ...
            fire_groups.append(
                parse_fire_group_data(
                    fg=fg, w=w, w_d=w_d, fire_groups_id_idx=fire_groups_id_idx,
                )
            )
            ...
            for zef in at.get("zone_effects", []):
                ...
                if eft["description"] == "Weapon Add Fire Group":
                    ...
                    attachment_fire_groups.append(
                        parse_attachment_fire_group_data(
                            fg=a_fg, fire_groups_id_idx=fire_groups_id_idx,
                        )
                    )

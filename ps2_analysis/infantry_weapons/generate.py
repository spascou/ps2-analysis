        ...
        for _fm in sorted(
            ...
            fire_mode: FireMode = FireMode(
                ...
                ammo=(
                    ...
                    if no_ammo_nor_heat is False
                    and optget(fm, "fire_ammo_per_shot", int, 0) > 0
                    else None
                ),
                heat=(
                    Heat(
                    ...
                    if no_ammo_nor_heat is False
                    and optget(w, "heat_capacity", int, 0) > 0
                    else None
                ),
                # Fire timing
        ...
        for _fg in sorted(
            ...
            fire_groups.append(
                parse_fire_group_data(
                    fg_id=fg_id, w=w, w_d=w_d, fire_groups_id_idx=fire_groups_id_idx,
                )
            )

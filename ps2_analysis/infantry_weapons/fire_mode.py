...
class FireMode:
    ...
    def __init__(
        ...
        # Damage profiles
        self.direct_damage_profile = direct_damage_profile
        self.indirect_damage_profile = indirect_damage_profile

        # Zoom
        self.zoom = zoom

        # Sway
        self.sway_can_steady = sway_can_steady
        self.sway_amplitude_x = sway_amplitude_x
        self.sway_amplitude_y = sway_amplitude_y
        self.sway_period_x = sway_period_x
        self.sway_period_y = sway_period_y
        ...
        # Player state cones of fire
        self.player_state_cone_of_fire = player_state_cone_of_fire

        # Player state can ads
        self.player_state_can_ads = player_state_can_ads

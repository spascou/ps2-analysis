...
class FireTiming:
    ...
    def __init__(
        ...
        self.refire_time = refire_time
        self.fire_duration = fire_duration

        # Burst
        self.burst_length = burst_length
        self.burst_refire_time = burst_refire_time

        # Delay
        self.delay = delay

        # Charge
        self.charge_up_time = charge_up_time

        # Spooling
        self.spool_up_time = spool_up_time
        self.spool_up_initial_refire_time = spool_up_initial_refire_time
